...
//
//*****************************************************************************
typedef void (* tInterfaceCallback)(unsigned long ulIndex,
...
typedef struct
{
    ...
    //
    void (* pfnGetDescriptor)(unsigned long ulIndex, tUSBRequest *pUSBRequest);
...
//
//! Data is has been received and is available for reading.
//
