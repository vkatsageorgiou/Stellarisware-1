========================================================================
       Luminary Micro Device Firmware Upgrade Interface Library
========================================================================

This project contains a DLL offering access to the USB Device Firmware
Upgrade function available on Luminary Micro USB-enabled microcontrollers.
The API here may be used to download new application binaries to devices
running the Luminary Micro USB boot loader and also to perform various
