...
// wLength       - sizeof(tLMDFUQueryLuminaryProtocol)
//
//*****************************************************************************
...
//*****************************************************************************
//
// Masks and shifts related to the ulClassInfo field of luminary_device_info
//
//*****************************************************************************
#define LUMINARY_INFO_VER_M       0x70000000  // ClassInfo version mask
#define LUMINARY_INFO_VER_SHIFT   28
#define LUMINARY_INFO_VER_0       0x00000000  // ClassInfo version 0
#define LUMINARY_INFO_VER_1       0x10000000  // ClassInfo version 1
#define LUMINARY_INFO_CLASS_M     0x00FF0000  // Stellaris Device Class
#define LUMINARY_INFO_CLASS_SHIFT 16
#define LUMINARY_INFO_CLASS_DUSTDEVIL \
                                0x00030000    // DustDevil-class Device
#define LUMINARY_INFO_MAJ_M       0x0000FF00  // Major revision mask
#define LUMINARY_INFO_MAJ_SHIFT   8
#define LUMINARY_INFO_MIN_M       0x000000FF  // Minor revision mask
#define LUMINARY_INFO_MIN_SHIFT   0

#define LUMINARY_PART_M           0x00FF0000
#define LUMINARY_PART_SHIFT       16

#define LUMINARY_ERASE_ALL   1
#define LUMINARY_ERASE_BLOCK 0

//*****************************************************************************
//
// Luminary Micro-specific command identifiers.  These are passed to the device
// in standard DFU download requests.
//
//*****************************************************************************
#define LUMINARY_CMD_PROG  0x01
#define LUMINARY_CMD_READ  0x02
#define LUMINARY_CMD_CHECK 0x03
#define LUMINARY_CMD_ERASE 0x04
#define LUMINARY_CMD_INFO  0x05
#define LUMINARY_CMD_BIN   0x06
#define LUMINARY_CMD_RESET 0x07
...
#define LUMINARY_CMD_LEN (sizeof(tDFUDownloadHeader))

//*****************************************************************************
//
// Header for the LUMINARY_CMD_PROG command.
//
...
// aborted.
//
// By using this protocol, the LUMINARY_CMD_PROG command header may be used as
// a simple header on the binary files to be sent to the DFU device for
// programming.  If we enforce the requirement that the LUMINARY_CMD_PROG header
// is applied to each USBD_DFU_REQUEST_DNLOAD (one per block), this means that the
...
typedef struct
{
    unsigned char  ucCommand;   // LUMINARY_CMD_PROG
...
//****************************************************************************
//
// Header for the LUMINARY_CMD_READ and LUMINARY_CMD_CHECK commands.
//
// The LUMINARY_CMD_READ command may be used to set the address range whose content
// will be returned on subsequent USBD_DFU_REQUEST_UPLOAD requests from the
// host.
//
// To read back a the contents of a region of flash, the host should send
// USBD_DFU_REQUEST_DNLOAD with ucCommand LUMINARY_CMD_READ, usStartAddr set
...
//
// To check that a region of flash is erased, the LUMINARY_CMD_CHECK command
...
typedef struct
{
    unsigned char  ucCommand;    // LUMINARY_CMD_READ or LUMINARY_CMD_CHECK
...
//****************************************************************************
//
// Header for the LUMINARY_CMD_ERASE command.
//
...
// size of the device may be determined using the LUMINARY_CMD_INFO command.
//
//*****************************************************************************
typedef struct
{
    unsigned char  ucCommand;      // LUMINARY_CMD_ERASE
...
//****************************************************************************
//
// Header for the LUMINARY_CMD_INFO command.
//
...
typedef struct
{
    unsigned char ucCommand;     // LUMINARY_CMD_INFO
...
//****************************************************************************
//
// Header for the LUMINARY_CMD_BIN command.
//
// This command may be used to tell the device whether or not to include the
// LUMINARY_CMD_PROG header before downloaded data.  By default, this is the
...
typedef struct
{
    unsigned char ucCommand;     // LUMINARY_CMD_BIN
...
//*****************************************************************************
//
// Payload returned in response to the LUMINARY_CMD_INFO command.
//
// This is structure is returned in response to the first
// USBD_DFU_REQUEST_UPLOAD request following a LUMINARY_CMD_INFO command.
//
//*****************************************************************************
typedef struct
{
